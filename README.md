...
```
The structure is a experimental combination of SPA based on Vue 2 and MUG based on Three.js, MIDI.js, etc. They basically are independent, but using the shared assets and services.
